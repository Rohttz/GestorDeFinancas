...
import { Plus, Edit2, Trash2, ChevronRight, Tag, CreditCard, User, LogOut, X } from 'lucide-react-native';
...
const ConfiguracoesScreen = () => {
  ...
  const {
    ...
    handleSubmit: handleContaSubmit,
    setValue: setContaValue,
    reset: resetConta,
  } = useForm({
            ...
            <ScrollView style={styles.modalScroll}>
              {activeSection === 'categorias' && (
                <>
                  ...
                  <Button
                    ...
                    onPress={handleCategoriaSubmit(onSubmitCategoria)}
                    loading={loading}
                  />
                </>
              )}
              ...
              {activeSection === 'contas' && (
                <>
                  ...
                  <Button
                    title={editingId ? 'Atualizar' : 'Cadastrar'}
                    onPress={handleContaSubmit(onSubmitConta)}
                    loading={loading}
                  />
                </>
              )}
              ...
              {activeSection === 'usuarios' && (
                <>
                  ...
                  <Button
                    title={editingId ? 'Atualizar' : 'Cadastrar'}
                    onPress={handleUsuarioSubmit(onSubmitUsuario)}
                    loading={loading}
                  />
                </>
              )}
